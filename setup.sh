...
cd /home/ubuntu/boomi-iot-simulation && wget https://github.com/thecloudgarage/Boomi-based-simulator/blob/main/docker-compose.yml
...
cd /home/ubuntu/boomi-iot-simulation/mosquitto && wget https://github.com/thecloudgarage/Boomi-based-simulator/blob/main/mosquitto.conf
